                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="config_key" name="config_key" type="text" 
                            ...
                            @include('partials.error-validation', ['error_validation' => 'config_key'])
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="config_value" name="config_value" type="text" 
                                                        class="form-control @error('title') is-invalid @enderror">
                            @include('partials.error-validation', ['error_validation' => 'config_value'])
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        class="form-control @error('title') is-invalid @enderror"></textarea>
                            @include('partials.error-validation', ['error_validation' => 'config_value'])
