    ...
    <div data-simplebar="" class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="<?php echo e(route('menus.index')); ?>" class=" waves-effect">
                ...
                <li>
                    <a href="<?php echo e(route('permissions.createPermission')); ?>" class=" waves-effect">
                        <i class="bx bx-menu-alt-left"></i>
...
<!-- Left Sidebar End -->
<?php /**PATH D:\php_mySQL_cakephp2_laravel\laravel\laravel_learn_from_youtube\laravel_shopping\laravel_backend\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>