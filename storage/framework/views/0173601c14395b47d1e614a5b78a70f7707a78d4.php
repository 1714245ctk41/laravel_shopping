        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo e(asset('assets/images/logo.svg')); ?>" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                ...
                <a href="index.html" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo e(asset('assets/images/logo-light.svg')); ?>" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo e(asset('assets/images/logo-light.png')); ?>" alt="" height="19">
                    </span>
                </a>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div>
                                        <img src="<?php echo e(asset('assets/images/megamenu-img.png')); ?>" alt=""
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="<?php echo e(asset('assets/images/flags/spain.jpg')); ?>" alt="user-image" class="mr-1" height="12">
                        <span class="align-middle">Spanish</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="<?php echo e(asset('assets/images/flags/germany.jpg')); ?>" alt="user-image" class="mr-1" height="12">
                        <span class="align-middle">German</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="<?php echo e(asset('assets/images/flags/italy.jpg')); ?>" alt="user-image" class="mr-1" height="12">
                        <span class="align-middle">Italian</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="<?php echo e(asset('assets/images/flags/russia.jpg')); ?>" alt="user-image" class="mr-1" height="12">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
                    ...
                    <div data-simplebar="" style="max-height: 230px;">
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="media">
                                <img src="<?php echo e(asset('assets/images/users/avatar-3.jpg')); ?>" class="mr-3 rounded-circle avatar-xs"
                                    alt="user-pic">
                                <div class="media-body">
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="media">
                                <img src="<?php echo e(asset('assets/images/users/avatar-4.jpg')); ?>" class="mr-3 rounded-circle avatar-xs"
                                    alt="user-pic">
                                <div class="media-body">
...
<?php /**PATH D:\php_mySQL_cakephp2_laravel\laravel\laravel_learn_from_youtube\laravel_shopping\laravel_backend\resources\views/partials/header.blade.php ENDPATH**/ ?>